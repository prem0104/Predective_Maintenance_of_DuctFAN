...
unsigned long myChannelNumber = 2277292;
const char * myWriteAPIKey = "NYE8PV9UFSA4YCDP";
const char* ssid = "Prem_wifi";
const char* password = "Prem@0104";
int vibrationsensor = 26;
